...
$options = array(
  'survey-settings' =>   array(
      ...
      'survey_orderby'  => array(
        ...
        'type'  => 'select',
         'options'  => array( 'date' => __( 'DATE','yith-woocommerce-surveys'), 'title'=> __('NAME' , 'yith-woocommerce-surveys') ),
          'defaut'  => 'date',
          'id'  => 'ywcsur_orderby'
      ),
      'survey_order'    => array(
        'name'  => __( 'Order', 'yith-woocommerce-surveys'),
         'type' =>'select',
          'options' => array( 'asc' => __('ASC', 'yith-woocommerce-surveys'), 'desc'=> __('DESC','yith-woocommerce-surveys')),
          'default' => 'asc',
          'id'  => 'ywcsur_order'
      ),
